# Generalized Hodge Conjecture — Canonical Lane Mathlib
...
```bash
git clone https://github.com/HautevilleHouse/generalized-hodge-conjecture-canonical-lane-mathlib.git
cd generalized-hodge-conjecture-canonical-lane-mathlib
lake exe
lake build
```
